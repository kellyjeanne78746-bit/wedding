  ...
  <form class="gate-card" method="POST" action="${GATE_LOGIN_PATH}">
    ...
    <div class="gate-form-col">
      ...
      <div class="field field-pw">
        <input id="passcode" name="passcode" type="password" autocomplete="off" placeholder="Please enter your pin code to access the site" aria-label="Pin code" required>
        <button type="button" class="pw-toggle" id="pwToggle" aria-label="Show pin code" aria-pressed="false">
  ...
  <script>
    (function () {
      ...
      t.addEventListener('click', function () {
        ...
        t.setAttribute('aria-label', reveal ? 'Hide pin code' : 'Show pin code');
      });
    })();
  </script>
</body>
...
export async function onRequest(context) {
  ...
  if (path === GATE_LOGIN_PATH) {
    ...
    return gatePage("That pin code wasn't right. Please check your invitation and try again.", email);
  }
